package com.example.administrator.superdialog;
...
import com.example.superdialoglibrary.BaseSuperDialog;
import com.example.superdialoglibrary.SuperDialog;
import com.example.superdialoglibrary.ViewConvertListener;
import com.example.superdialoglibrary.ViewHolder;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showDialog0(View view) {
        SuperDialog.init()
                ...
                .setConvertListener(new ViewConvertListener() {
                    @Override
                    public void convertView(ViewHolder holder, final BaseSuperDialog dialog) {
    ...
    public static class ConfirmDialog extends BaseSuperDialog {
